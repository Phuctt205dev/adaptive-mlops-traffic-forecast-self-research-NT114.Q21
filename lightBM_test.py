...
from src.train import train_lightgbm   # ✅ dùng từ train.py
...
train_end = start_date + pd.DateOffset(months=20)
...
result_path = "results/lightgbm_prediction_no_lag.csv"
